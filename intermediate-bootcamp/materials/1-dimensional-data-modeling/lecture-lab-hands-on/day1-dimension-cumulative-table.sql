...
-- one great thing with this cumulative design, is you can do all your joins first,
-- and when you unnest the temporal components, the table is still sorted and holds compression
